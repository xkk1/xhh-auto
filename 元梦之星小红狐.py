...
def 主函数():
    ...
    # 设置脚本目录
    os.environ["SCRIPT_DIR"] = (启动器目录 / "脚本").as_posix()
    sys.path.append((启动器目录 / "脚本").as_posix())
    sys.path.append((启动器目录 / "脚本" / "小红狐.zip").as_posix())
    sys.path.append((启动器目录 / "脚本" / "小红狐.pyz").as_posix())
    # 设置 Debug 模式
