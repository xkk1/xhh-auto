...
(function (全局对象) {
    ...
    let 页面 = {
        ...
        添加脚本: function(页面名="页面名六个字", 脚本模块名="小红狐") {
            return 请求.新增(this.api前缀 + `/脚本/${页面名}/${脚本模块名}`);
        },
        删除脚本: function(页面名="页面名六个字", 脚本模块名="小红狐") {
            return 请求.删除(this.api前缀 + `/脚本/${页面名}/${脚本模块名}`);
        },
        修改配置页面URL排序: function(页面名="页面名六个字", 配置页面URL排序) {
            return 请求.修改(this.api前缀 + `/配置页面URL排序/${页面名}`, {
                配置页面URL排序: 配置页面URL排序,
            });
        },
    };
