...
def 关闭配置数据(配置名: str | None = None, 脚本模块名: str | None = None) -> None:
    return 关闭路径下的所有本地数据(获取配置目录(配置名=配置名, 脚本模块名=脚本模块名))
...
def 获取页面生成脚本(配置名: str = "默认") -> dict[str, str]:
    ...
    try:
        ...
        assert callable(脚本模块["页面生成"][页面生成脚本["页面生成脚本名"]]["新建页面"]), "页面生成新建页面函数非法"
    except Exception as e:
        # 改为默认页面生成脚本
        修改页面生成脚本(配置名=配置名, 脚本模块名=小红狐模块名, 页面生成脚本名=默认启用页面生成脚本名)
        日志.警告(f"配置“{配置名}”改为使用默认页面生成脚本 {页面生成脚本['脚本模块名']} {页面生成脚本['页面生成脚本名']} 错误: {e}\n" + traceback.format_exc())
...
def 修改页面生成脚本(配置名: str = "默认", 脚本模块名: str | None = None, 页面生成脚本名: str | None = None) -> None:
    ...
    配置数据["页面生成脚本"] = {"脚本模块名": 脚本模块名, "页面生成脚本名": 页面生成脚本名}
    配置数据.保存()
