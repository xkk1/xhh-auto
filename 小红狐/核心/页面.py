...
def 获取页面目录(页面名: Optional[str]=None):
    if 页面名:
        return 页面目录 / 页面名
    else:
        return 页面目录
...
def 获取页面数据(页面名: Optional[str]=None, 默认值: Optional[Dict[str, Any]] = None) -> 数据类:
